...
class DevlogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create devlog" do
    assert_difference("Devlog.count") do
      post devlogs_url, params: { devlog: { data: @devlog.data, deviceid: @devlog.deviceid, devlogs: @devlog.devlogs } }
    end
  ...
  test "should update devlog" do
    patch devlog_url(@devlog), params: { devlog: { data: @devlog.data, deviceid: @devlog.deviceid, devlogs: @devlog.devlogs } }
